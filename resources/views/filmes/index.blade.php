...
<div style="max-width: 1280px; margin: 0 auto; padding: 0 16px;">
    ...
    <!-- MENSAGEM DE SUCESSO (aparece após cadastrar/editar/excluir) -->
    @if(session('sucesso'))
        ...
        <div class="grid-container" style="display: grid; gap: 24px;">
            ...
            <div class="card-galaxy" style="transition: all 0.3s;">
                ...
                <div style="padding: 16px;">
                    ...
                    <!-- SINOPSE COM BOTÃO LER MAIS/LER MENOS -->
                    @if($filme->sinopse)
    ...
    <!-- PAGINAÇÃO (usando o arquivo personalizado galaxy.blade.php) -->
